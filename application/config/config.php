...
|
*/
$config['base_url'] = 'http://localhost/verbs/Contact';
...
|--------------------------------------------------------------------------
|
| Typically this will be your freeThrow.php file, unless you've renamed it to
| something else. If you are using mod_rewrite to remove the page set this
| variable so that it is blank.
|
*/
$config['index_page'] = 'freeThrow.php';
...
| example.com/freeThrow.php?c=controller&m=function
|
